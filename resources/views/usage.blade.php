...
@section('content')
    <h1 class="title">Conditions Générales d'Utilisation (CGU)</h1>
    <p class="paragraph">
        <span>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Atque consectetur eum fuga fugit ipsam maiores nemo optio placeat, tempora unde ut velit vero! Itaque laborum nostrum quas quo tempora, vero?</span><span>Ad aspernatur ea eum expedita itaque iusto natus optio, porro quae, quaerat quas quia quisquam ratione rem rerum sapiente sed sequi sunt velit veritatis! Animi dolore eaque tempore veritatis voluptatem!</span><span>Corporis eligendi fugiat maiores nam, numquam perspiciatis praesentium quam quas quis ratione rem saepe temporibus velit? Amet, blanditiis corporis dolores ea, explicabo in labore laboriosam non praesentium qui, reiciendis tempora!</span>
    </p>
    <h2 class="title">Hébergement</h2>
    <p class="paragraph">
        <span>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab architecto fugit, incidunt, placeat quia quisquam, quod repudiandae sint suscipit tempora velit vitae voluptatum. Ab alias eveniet facere, in labore mollitia.</span><span>Ad asperiores cumque cupiditate debitis, distinctio, dolor dolores eligendi esse et exercitationem fugiat fugit hic molestiae, nemo nesciunt nihil nobis nostrum nulla numquam officiis quaerat quibusdam sequi suscipit vero voluptas.</span>
    </p>
    <h2 class="title">Obligations liées à la transparence de l'information</h2>
    <p class="paragraph">
